...
MACRO (MYSQL_USE_BUNDLED_EDITLINE)
  ...
  SET(EDITLINE_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/src/core/editline)
  SET(EDITLINE_LIBRARY edit)
  FIND_CURSES()
  ADD_SUBDIRECTORY(${CMAKE_SOURCE_DIR}/src/core/editline)
ENDMACRO()
...
MACRO (MYSQL_CHECK_EDITLINE)
  IF (NOT WIN32)
    ...
    IF(WITH_EDITLINE STREQUAL "bundled")
      MESSAGE(STATUS "EIDIT_LINE LIB use bundled")
