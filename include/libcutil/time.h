...
typedef __typeof__(tv.tv_sec) ast_time_t;
typedef __typeof__(tv.tv_usec) ast_suseconds_t;
 ...
 */
AST_INLINE_API(int64_t ast_tvdiff_sec(struct timeval end, struct timeval start),
               {
 ...
 */
AST_INLINE_API(int64_t ast_tvdiff_us(struct timeval end, struct timeval start),
               {
 ...
 */
AST_INLINE_API(int64_t ast_tvdiff_ms(struct timeval end, struct timeval start),
               {
 ...
 */
AST_INLINE_API(int ast_tvzero(const struct timeval t),
 ...
 */
AST_INLINE_API(int ast_tvcmp(struct timeval _a, struct timeval _b),
               {
 ...
 */
AST_INLINE_API(int ast_tveq(struct timeval _a, struct timeval _b),
 ...
 */
AST_INLINE_API(struct timeval ast_tvnow(void),
               {
                 struct timeval t;
                 gettimeofday(&t, NULL);
                 return t;
 ...
 */
AST_INLINE_API(struct timeval ast_samp2tv(unsigned int _nsamp,
                                          unsigned int _rate),
               {
                 return ast_tv(_nsamp / _rate,
                               (_nsamp % _rate) * (1000000 / (float)_rate));
               }
