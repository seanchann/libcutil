...
#ifndef _CUTIL_LOCK_H
#define _CUTIL_LOCK_H
...
#endif  // ifndef HAVE_PTHREAD_RWLOCK_TIMEDWRLOCK
...
/* Asterisk REQUIRES recursive (not error checking) mutexes
   and will not run without them. */
    ...
    defined(HAVE_PTHREAD_MUTEX_RECURSIVE_NP)
#define PTHREAD_MUTEX_INIT_VALUE PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP
#define AST_MUTEX_KIND PTHREAD_MUTEX_RECURSIVE_NP
#else  // if defined(HAVE_PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP) &&
// defined(HAVE_PTHREAD_MUTEX_RECURSIVE_NP)
...
#ifdef HAVE_BKTR
#define AST_LOCK_TRACK_INIT_VALUE \
  { {NULL}, {0}, 0, {NULL}, {0}, {{{0}}}, PTHREAD_MUTEX_INIT_VALUE }
#else  // ifdef HAVE_BKTR
#define AST_LOCK_TRACK_INIT_VALUE \
  { {NULL}, {0}, 0, {NULL}, {0}, PTHREAD_MUTEX_INIT_VALUE }
#endif  // ifdef HAVE_BKTR

#define AST_MUTEX_INIT_VALUE \
  { PTHREAD_MUTEX_INIT_VALUE, NULL, 1 }
#define AST_MUTEX_INIT_VALUE_NOTRACKING \
  { PTHREAD_MUTEX_INIT_VALUE, NULL, 0 }

#define AST_RWLOCK_INIT_VALUE \
  { __AST_RWLOCK_INIT_VALUE, NULL, 1 }
#define AST_RWLOCK_INIT_VALUE_NOTRACKING \
  { __AST_RWLOCK_INIT_VALUE, NULL, 0 }
 ...
 *
 * We have tracking information in this structure regardless of DEBUG_THREADS
 * being enabled.
 * The information will just be ignored in the core if a module does not request
 * it..
 */
...
typedef struct ast_mutex_info cutil_mutex_t;

typedef struct ast_rwlock_info ast_rwlock_t;
typedef struct ast_rwlock_info cutil_rwlock_t;

typedef pthread_cond_t ast_cond_t;
typedef pthread_cond_t cutil_cond_t;

int __ast_pthread_mutex_init(int tracking, const char *filename, int lineno,
                             const char *func, const char *mutex_name,
                             ast_mutex_t *t);
int __ast_pthread_mutex_destroy(const char *filename, int lineno,
                                const char *func, const char *mutex_name,
                                ast_mutex_t *t);
int __ast_pthread_mutex_lock(const char *filename, int lineno, const char *func,
                             const char *mutex_name, ast_mutex_t *t);
int __ast_pthread_mutex_trylock(const char *filename, int lineno,
                                const char *func, const char *mutex_name,
                                ast_mutex_t *t);
int __ast_pthread_mutex_unlock(const char *filename, int lineno,
                               const char *func, const char *mutex_name,
                               ast_mutex_t *t);

#define ast_mutex_init(pmutex)                                         \
  __ast_pthread_mutex_init(1, __FILE__, __LINE__, __PRETTY_FUNCTION__, \
                           #pmutex, pmutex)
#define ast_mutex_init_notracking(pmutex)                              \
  __ast_pthread_mutex_init(0, __FILE__, __LINE__, __PRETTY_FUNCTION__, \
                           #pmutex, pmutex)
#define ast_mutex_destroy(a) \
  __ast_pthread_mutex_destroy(__FILE__, __LINE__, __PRETTY_FUNCTION__, #a, a)
#define ast_mutex_lock(a) \
  __ast_pthread_mutex_lock(__FILE__, __LINE__, __PRETTY_FUNCTION__, #a, a)
#define ast_mutex_unlock(a) \
  __ast_pthread_mutex_unlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, #a, a)
#define ast_mutex_trylock(a) \
  __ast_pthread_mutex_trylock(__FILE__, __LINE__, __PRETTY_FUNCTION__, #a, a)
...
#define ast_cond_destroy(cond) \
  __ast_cond_destroy(__FILE__, __LINE__, __PRETTY_FUNCTION__, #cond, cond)
#define ast_cond_signal(cond) \
  __ast_cond_signal(__FILE__, __LINE__, __PRETTY_FUNCTION__, #cond, cond)
#define ast_cond_broadcast(cond) \
  __ast_cond_broadcast(__FILE__, __LINE__, __PRETTY_FUNCTION__, #cond, cond)
#define ast_cond_wait(cond, mutex)                                        \
  __ast_cond_wait(__FILE__, __LINE__, __PRETTY_FUNCTION__, #cond, #mutex, \
                  cond, mutex)
#define ast_cond_timedwait(cond, mutex, time)                                  \
  __ast_cond_timedwait(__FILE__, __LINE__, __PRETTY_FUNCTION__, #cond, #mutex, \
                       cond, mutex, time)

int __ast_rwlock_init(int tracking, const char *filename, int lineno,
                      const char *func, const char *rwlock_name,
                      ast_rwlock_t *t);
int __ast_rwlock_destroy(const char *filename, int lineno, const char *func,
                         const char *rwlock_name, ast_rwlock_t *t);
int __ast_rwlock_unlock(const char *filename, int lineno, const char *func,
                        ast_rwlock_t *t, const char *name);
int __ast_rwlock_rdlock(const char *filename, int lineno, const char *func,
                        ast_rwlock_t *t, const char *name);
int __ast_rwlock_wrlock(const char *filename, int lineno, const char *func,
                        ast_rwlock_t *t, const char *name);
int __ast_rwlock_timedrdlock(const char *filename, int lineno, const char *func,
                             ast_rwlock_t *t, const char *name,
                             const struct timespec *abs_timeout);
int __ast_rwlock_timedwrlock(const char *filename, int lineno, const char *func,
                             ast_rwlock_t *t, const char *name,
                             const struct timespec *abs_timeout);
int __ast_rwlock_tryrdlock(const char *filename, int lineno, const char *func,
                           ast_rwlock_t *t, const char *name);
int __ast_rwlock_trywrlock(const char *filename, int lineno, const char *func,
                           ast_rwlock_t *t, const char *name);
...
#define ast_rwlock_init(rwlock) \
  __ast_rwlock_init(1, __FILE__, __LINE__, __PRETTY_FUNCTION__, #rwlock, rwlock)
 ...
 * \since 1.6.1
 */
#define ast_rwlock_init_notracking(rwlock) \
  __ast_rwlock_init(0, __FILE__, __LINE__, __PRETTY_FUNCTION__, #rwlock, rwlock)

#define ast_rwlock_destroy(rwlock) \
  __ast_rwlock_destroy(__FILE__, __LINE__, __PRETTY_FUNCTION__, #rwlock, rwlock)
#define ast_rwlock_unlock(a) \
  __ast_rwlock_unlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, a, #a)
#define ast_rwlock_rdlock(a) \
  __ast_rwlock_rdlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, a, #a)
#define ast_rwlock_wrlock(a) \
  __ast_rwlock_wrlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, a, #a)
#define ast_rwlock_tryrdlock(a) \
  __ast_rwlock_tryrdlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, a, #a)
#define ast_rwlock_trywrlock(a) \
  __ast_rwlock_trywrlock(__FILE__, __LINE__, __PRETTY_FUNCTION__, a, #a)
...
#else  // ifdef THREAD_CRASH
#define DO_THREAD_CRASH \
  do {                  \
  } while (0)
#endif  // ifdef THREAD_CRASH
...
#define AO2_DEADLOCK_AVOIDANCE(obj)                                            \
  do {                                                                         \
    ...
    int __lineno;                                                              \
    int __res = ast_find_lock_info(ao2_object_get_lockaddr(obj), __filename,   \
                                   sizeof(__filename), &__lineno, __func,      \
                                   sizeof(__func), __mutex_name,               \
                                   sizeof(__mutex_name));                      \
    int __res2 = ao2_unlock(obj);                                              \
    usleep(1);                                                                 \
    if (__res <                                                                \
        0) { /* Could happen if the ao2 object does not have a mutex. */       \
      if (__res2) {                                                            \
        ast_log(LOG_WARNING,                                                   \
                "Could not unlock ao2 object '%s': %s and no lock info "       \
                "found!  I will NOT try to relock.\n",                         \
                #obj, strerror(__res2));                                       \
      } else {                                                                 \
        ao2_lock(obj);                                                         \
      }                                                                        \
      ...
      if (__res2) {                                                            \
        ast_log(LOG_WARNING,                                                   \
                "Could not unlock ao2 object '%s': %s.  {{{Originally locked " \
                "at %s line %d: (%s) '%s'}}}  I will NOT try to relock.\n",    \
                #obj, strerror(__res2), __filename, __lineno, __func,          \
                __mutex_name);                                                 \
      } else {                                                                 \
        __ao2_lock(obj, AO2_LOCK_REQ_MUTEX, __filename, __func, __lineno,      \
                   __mutex_name);                                              \
      }                                                                        \
    }                                                                          \
  } while (0)
...
#define CHANNEL_DEADLOCK_AVOIDANCE(chan)                                       \
  do {                                                                         \
    char __filename[80], __func[80], __mutex_name[80];                         \
    int __lineno;                                                              \
    int __res = ast_find_lock_info(ao2_object_get_lockaddr(chan), __filename,  \
                                   sizeof(__filename), &__lineno, __func,      \
                                   sizeof(__func), __mutex_name,               \
                                   sizeof(__mutex_name));                      \
    ...
    if (__res < 0) { /* Shouldn't ever happen, but just in case... */          \
      if (__res2) {                                                            \
        ast_log(LOG_WARNING,                                                   \
                "Could not unlock channel '%s': %s and no lock info found!  "  \
                "I will NOT try to relock.\n",                                 \
      ...
      if (__res2) {                                                            \
        ast_log(LOG_WARNING,                                                   \
                "Could not unlock channel '%s': %s.  {{{Originally locked at " \
                "%s line %d: (%s) '%s'}}}  I will NOT try to relock.\n",       \
                #chan, strerror(__res2), __filename, __lineno, __func,         \
                __mutex_name);                                                 \
      } else {                                                                 \
        __ao2_lock(chan, AO2_LOCK_REQ_MUTEX, __filename, __func, __lineno,     \
                   __mutex_name);                                              \
      }                                                                        \
    }                                                                          \
  } while (0)
...
#define DEADLOCK_AVOIDANCE(lock)                                              \
  do {                                                                        \
    char __filename[80], __func[80], __mutex_name[80];                        \
    int __lineno;                                                             \
    int __res = ast_find_lock_info(lock, __filename, sizeof(__filename),      \
                                   &__lineno, __func, sizeof(__func),         \
                                   __mutex_name, sizeof(__mutex_name));       \
    ...
    if (__res < 0) { /* Shouldn't ever happen, but just in case... */         \
      if (__res2 == 0) {                                                      \
        ...
        ast_log(LOG_WARNING,                                                  \
                "Could not unlock mutex '%s': %s and no lock info found!  I " \
                "will NOT try to relock.\n",                                  \
                #lock, strerror(__res2));                                     \
      }                                                                       \
    } else {                                                                  \
      if (__res2 == 0) {                                                      \
        __ast_pthread_mutex_lock(__filename, __lineno, __func, __mutex_name,  \
                                 lock);                                       \
      } else {                                                                \
        ast_log(LOG_WARNING,                                                  \
                "Could not unlock mutex '%s': %s.  {{{Originally locked at "  \
                "%s line %d: (%s) '%s'}}}  I will NOT try to relock.\n",      \
                #lock, strerror(__res2), __filename, __lineno, __func,        \
                __mutex_name);                                                \
      }                                                                       \
    }                                                                         \
  } while (0)
...
#define DLA_LOCK(lock)                                                        \
  if (__res < 0) { /* Shouldn't ever happen, but just in case... */           \
    ...
    if (__res2) {                                                             \
      ast_log(LOG_WARNING,                                                    \
              "Could not unlock mutex '%s': %s.  {{{Originally locked at %s " \
              "line %d: (%s) '%s'}}}  I will NOT try to relock.\n",           \
              #lock, strerror(__res2), __filename, __lineno, __func,          \
              __mutex_name);                                                  \
    } else {                                                                  \
      __ast_pthread_mutex_lock(__filename, __lineno, __func, __mutex_name,    \
...
static inline void ast_reentrancy_lock(struct ast_lock_track *lt) {
  ...
  if ((res = pthread_mutex_lock(&lt->reentr_mutex))) {
    ...
    abort();
#endif  // if defined(DO_CRASH) || defined(THREAD_CRASH)
  }
}
...
#define DEADLOCK_AVOIDANCE(lock)                                              \
  do {                                                                        \
    ...
    if (!(__res = ast_mutex_unlock(lock))) {                                  \
      ...
      ast_log(LOG_WARNING,                                                    \
              "Failed to unlock mutex '%s' (%s).  I will NOT try to relock. " \
              "{{{ THIS IS A BUG. }}}\n",                                     \
              #lock, strerror(__res));                                        \
    }                                                                         \
  } while (0)
...
#define AST_MUTEX_DEFINE_STATIC(mutex) \
  __AST_MUTEX_DEFINE(static, mutex, AST_MUTEX_INIT_VALUE, 1)
#define AST_MUTEX_DEFINE_STATIC_NOTRACKING(mutex) \
  __AST_MUTEX_DEFINE(static, mutex, AST_MUTEX_INIT_VALUE_NOTRACKING, 0)
...
#else  // ifdef AST_MUTEX_INIT_W_CONSTRUCTORS
#define __AST_RWLOCK_DEFINE(scope, rwlock, init_val, track) \
  scope ast_rwlock_t rwlock = init_val
#endif  // ifdef AST_MUTEX_INIT_W_CONSTRUCTORS

#define AST_RWLOCK_DEFINE_STATIC(rwlock) \
  __AST_RWLOCK_DEFINE(static, rwlock, AST_RWLOCK_INIT_VALUE, 1)
#define AST_RWLOCK_DEFINE_STATIC_NOTRACKING(rwlock) \
  __AST_RWLOCK_DEFINE(static, rwlock, AST_RWLOCK_INIT_VALUE_NOTRACKING, 0)
 ...
 * ao2 objects should be unlocked before they are unreffed. Since SCOPED_LOCK
 * runs
 * once the variable goes out of scope, this can easily lead to situations where
 * the
 * variable gets unlocked after it is unreffed.
 *
 * \param varname The unique name to give to the scoped lock. You are not likely
 * to reference
 * this outside of the SCOPED_LOCK invocation.
 * \param lock The variable to lock. This can be anything that can be passed to
 * a locking
...
#endif  // if defined(HAVE_OSX_ATOMICS)
...
#endif  // if defined(HAVE_GCC_ATOMICS)
...
#else   // if defined(HAVE_GCC_ATOMICS)
AST_INLINE_API(int ast_atomic_dec_and_test(volatile int *p), {
