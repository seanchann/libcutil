...
#define ast_mutex_init(pmutex) __ast_pthread_mutex_init(1,                   \
                                                        __FILE__,            \
                                                        __LINE__,            \
                                                        __PRETTY_FUNCTION__, \
                                                        # pmutex,            \
                                                        pmutex)
#define ast_mutex_init_notracking(pmutex) __ast_pthread_mutex_init(0,                   \
                                                                   __FILE__,            \
                                                                   __LINE__,            \
                                                                   __PRETTY_FUNCTION__, \
                                                                   # pmutex,            \
                                                                   pmutex)
#define ast_mutex_destroy(a) __ast_pthread_mutex_destroy(__FILE__,            \
                                                         __LINE__,            \
                                                         __PRETTY_FUNCTION__, \
                                                         # a,                 \
                                                         a)
#define ast_mutex_lock(a) __ast_pthread_mutex_lock(__FILE__,            \
                                                   __LINE__,            \
                                                   __PRETTY_FUNCTION__, \
                                                   # a,                 \
                                                   a)
#define ast_mutex_unlock(a) __ast_pthread_mutex_unlock(__FILE__,            \
                                                       __LINE__,            \
                                                       __PRETTY_FUNCTION__, \
                                                       # a,                 \
                                                       a)
#define ast_mutex_trylock(a) __ast_pthread_mutex_trylock(__FILE__,            \
                                                         __LINE__,            \
                                                         __PRETTY_FUNCTION__, \
                                                         # a,                 \
                                                         a)
...
#define ast_cond_init(cond, attr) __ast_cond_init(__FILE__,            \
                                                  __LINE__,            \
                                                  __PRETTY_FUNCTION__, \
                                                  # cond,              \
                                                  cond,                \
                                                  attr)
#define ast_cond_destroy(cond) __ast_cond_destroy(__FILE__,            \
                                                  __LINE__,            \
                                                  __PRETTY_FUNCTION__, \
                                                  # cond,              \
                                                  cond)
#define ast_cond_signal(cond) __ast_cond_signal(__FILE__,            \
                                                __LINE__,            \
                                                __PRETTY_FUNCTION__, \
                                                # cond,              \
                                                cond)
#define ast_cond_broadcast(cond) __ast_cond_broadcast(__FILE__,            \
                                                      __LINE__,            \
                                                      __PRETTY_FUNCTION__, \
                                                      # cond,              \
                                                      cond)
#define ast_cond_wait(cond, mutex) __ast_cond_wait(__FILE__,            \
                                                   __LINE__,            \
                                                   __PRETTY_FUNCTION__, \
                                                   # cond,              \
                                                   # mutex,             \
 ...
 * \since 1.6.1
 */
#define ast_rwlock_init(rwlock) __ast_rwlock_init(1,                   \
                                                  __FILE__,            \
                                                  __LINE__,            \
                                                  __PRETTY_FUNCTION__, \
                                                  # rwlock,            \
 ...
 * \since 1.6.1
 */
#define ast_rwlock_init_notracking(rwlock) __ast_rwlock_init(0,                   \
                                                             __FILE__,            \
                                                             __LINE__,            \
                                                             __PRETTY_FUNCTION__, \
                                                             # rwlock,            \
...
#define ast_rwlock_destroy(rwlock) __ast_rwlock_destroy(__FILE__,            \
                                                        __LINE__,            \
                                                        __PRETTY_FUNCTION__, \
                                                        # rwlock,            \
                                                        rwlock)
#define ast_rwlock_unlock(a) __ast_rwlock_unlock(__FILE__,            \
                                                 __LINE__,            \
                                                 __PRETTY_FUNCTION__, \
                                                 a,                   \
                                                 # a)
#define ast_rwlock_rdlock(a) __ast_rwlock_rdlock(__FILE__,            \
                                                 __LINE__,            \
                                                 __PRETTY_FUNCTION__, \
                                                 a,                   \
                                                 # a)
#define ast_rwlock_wrlock(a) __ast_rwlock_wrlock(__FILE__,            \
                                                 __LINE__,            \
                                                 __PRETTY_FUNCTION__, \
                                                 a,                   \
                                                 # a)
#define ast_rwlock_tryrdlock(a) __ast_rwlock_tryrdlock(__FILE__,            \
                                                       __LINE__,            \
                                                       __PRETTY_FUNCTION__, \
                                                       a,                   \
                                                       # a)
#define ast_rwlock_trywrlock(a) __ast_rwlock_trywrlock(__FILE__,            \
                                                       __LINE__,            \
                                                       __PRETTY_FUNCTION__, \
                                                       a,                   \
                                                       # a)
#define ast_rwlock_timedrdlock(a, b) __ast_rwlock_timedrdlock(__FILE__,            \
                                                              __LINE__,            \
                                                              __PRETTY_FUNCTION__, \
                                                              a,                   \
                                                              # a,                 \
                                                              b)
#define ast_rwlock_timedwrlock(a, b) __ast_rwlock_timedwrlock(__FILE__,            \
                                                              __LINE__,            \
                                                              __PRETTY_FUNCTION__, \
                                                              a,                   \
                                                              # a,                 \
...
# define __ast_mutex_logger(...)                                               \
  do { if (canlog) ast_log(LOG_ERROR, __VA_ARGS__); else fprintf(stderr,       \
                                                                 __VA_ARGS__); \
  } while (0)
...
# define AO2_DEADLOCK_AVOIDANCE(obj)                                                                                                    \
  do {                                                                                                                                  \
    ...
    int  __lineno;                                                                                                                      \
    int  __res = ast_find_lock_info(ao2_object_get_lockaddr(                                                                            \
                                      obj), __filename, sizeof(__filename), &__lineno, __func,                                          \
    ...
    if (__res < 0) { /* Could happen if the ao2 object does not have a mutex. */                                                        \
      if (__res2) {                                                                                                                     \
        ast_log(LOG_WARNING,                                                                                                            \
                "Could not unlock ao2 object '%s': %s and no lock info found!  I will NOT try to relock.\n",                            \
                # obj,                                                                                                                  \
                strerror(__res2));                                                                                                      \
      } else {                                                                                                                          \
        ao2_lock(obj);                                                                                                                  \
      ...
      if (__res2) {                                                                                                                     \
        ast_log(LOG_WARNING,                                                                                                            \
                "Could not unlock ao2 object '%s': %s.  {{{Originally locked at %s line %d: (%s) '%s'}}}  I will NOT try to relock.\n", \
                # obj,                                                                                                                  \
                strerror(__res2),                                                                                                       \
                __filename,                                                                                                             \
                __lineno,                                                                                                               \
...
# define CHANNEL_DEADLOCK_AVOIDANCE(chan)                                                                                            \
  do {                                                                                                                               \
    ...
    int  __lineno;                                                                                                                   \
    int  __res = ast_find_lock_info(ao2_object_get_lockaddr(                                                                         \
                                      chan), __filename, sizeof(__filename), &__lineno, __func,                                      \
                                    sizeof(__func), __mutex_name,                                                                    \
                                    sizeof(__mutex_name));                                                                           \
    ...
    if (__res < 0) { /* Shouldn't ever happen, but just in case... */                                                                \
      if (__res2) {                                                                                                                  \
        ast_log(LOG_WARNING,                                                                                                         \
                "Could not unlock channel '%s': %s and no lock info found!  I will NOT try to relock.\n",                            \
                # chan,                                                                                                              \
                strerror(__res2));                                                                                                   \
      } else {                                                                                                                       \
      ...
      if (__res2) {                                                                                                                  \
        ast_log(LOG_WARNING,                                                                                                         \
                "Could not unlock channel '%s': %s.  {{{Originally locked at %s line %d: (%s) '%s'}}}  I will NOT try to relock.\n", \
                # chan,                                                                                                              \
                strerror(__res2),                                                                                                    \
                __filename,                                                                                                          \
                __lineno,                                                                                                            \
...
# define DEADLOCK_AVOIDANCE(lock)                                                                                                  \
  do {                                                                                                                             \
    char __filename[80], __func[80], __mutex_name[80];                                                                             \
    int  __lineno;                                                                                                                 \
    int  __res = ast_find_lock_info(lock,                                                                                          \
                                    __filename,                                                                                    \
                                    sizeof(__filename),                                                                            \
                                    &__lineno,                                                                                     \
                                    __func,                                                                                        \
    ...
    if (__res < 0) { /* Shouldn't ever happen, but just in case... */                                                              \
      if (__res2 == 0) {                                                                                                           \
        ...
        ast_log(LOG_WARNING,                                                                                                       \
                "Could not unlock mutex '%s': %s and no lock info found!  I will NOT try to relock.\n",                            \
                # lock,                                                                                                            \
                strerror(__res2));                                                                                                 \
      }                                                                                                                            \
    } else {                                                                                                                       \
      if (__res2 == 0) {                                                                                                           \
        ...
        ast_log(LOG_WARNING,                                                                                                       \
                "Could not unlock mutex '%s': %s.  {{{Originally locked at %s line %d: (%s) '%s'}}}  I will NOT try to relock.\n", \
                # lock,                                                                                                            \
                strerror(__res2),                                                                                                  \
                __filename,                                                                                                        \
                __lineno,                                                                                                          \
...
# define __AST_MUTEX_DEFINE(scope, mutex, init_val, track)       \
  ...
  {                                                              \
    if (track) ast_mutex_init(&mutex);                           \
    else ast_mutex_init_notracking(&mutex);                      \
  }                                                              \
                                                                 \
...
#define AST_MUTEX_DEFINE_STATIC(mutex) __AST_MUTEX_DEFINE(static,               \
                                                          mutex,                \
                                                          AST_MUTEX_INIT_VALUE, \
                                                          1)
#define AST_MUTEX_DEFINE_STATIC_NOTRACKING(mutex) __AST_MUTEX_DEFINE(static,                          \
                                                                     mutex,                           \
...
# define __AST_RWLOCK_DEFINE(scope, rwlock, init_val, track)      \
  ...
  {                                                               \
    if (track) ast_rwlock_init(&rwlock);                          \
    else ast_rwlock_init_notracking(&rwlock);                     \
  }                                                               \
...
# define __AST_RWLOCK_DEFINE(scope, rwlock, init_val, \
                             track) scope ast_rwlock_t rwlock = init_val
#endif // ifdef AST_MUTEX_INIT_W_CONSTRUCTORS

#define AST_RWLOCK_DEFINE_STATIC(rwlock) __AST_RWLOCK_DEFINE(static,                \
                                                             rwlock,                \
                                                             AST_RWLOCK_INIT_VALUE, \
                                                             1)
#define AST_RWLOCK_DEFINE_STATIC_NOTRACKING(rwlock) __AST_RWLOCK_DEFINE(static,                           \
                                                                        rwlock,                           \
 ...
 */
#define SCOPED_MUTEX(varname, lock) SCOPED_LOCK(varname,        \
                                                (lock),         \
                                                ast_mutex_lock, \
                                                ast_mutex_unlock)
 ...
 */
#define SCOPED_RDLOCK(varname, lock) SCOPED_LOCK(varname,           \
                                                 (lock),            \
                                                 ast_rwlock_rdlock, \
                                                 ast_rwlock_unlock)
 ...
 */
#define SCOPED_WRLOCK(varname, lock) SCOPED_LOCK(varname,           \
                                                 (lock),            \
                                                 ast_rwlock_wrlock, \
                                                 ast_rwlock_unlock)
 ...
 */
#define SCOPED_AO2LOCK(varname, obj) SCOPED_LOCK(varname,  \
                                                 (obj),    \
                                                 ao2_lock, \
                                                 ao2_unlock)
 ...
 */
#define SCOPED_AO2RDLOCK(varname, obj) SCOPED_LOCK(varname,    \
                                                   (obj),      \
                                                   ao2_rdlock, \
                                                   ao2_unlock)
 ...
 */
#define SCOPED_AO2WRLOCK(varname, obj) SCOPED_LOCK(varname,    \
                                                   (obj),      \
                                                   ao2_wrlock, \
                                                   ao2_unlock)
 ...
 */
#define SCOPED_CHANNELLOCK(varname, chan) SCOPED_LOCK(varname,          \
                                                      (chan),           \
                                                      ast_channel_lock, \
                                                      ast_channel_unlock)
